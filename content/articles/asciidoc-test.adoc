...
image::sunset.jpg[sunset with imagesdir: prefix (::sunset.jpg)]
Sunset with prepended attribute relative path

image::/images/sunset.jpg[Sunset with absolute path to /static dir]
Sunset with absolute path (::/images/sunset.jpg)

.A mountain sunset from flickr
[img-sunset]
[caption="",link=https://www.flickr.com/photos/javh/5448336655]
image::sunset.jpg[Sunset,200,100]
200 x 100


image::https://asciidoctor.org/images/octocat.jpg[GitHub mascot with URL path]
_GitHub octocat mascot with URL path_
...
Click image:marker.png[title="Play marker"]

to get the party started.

Click image:marker.png[title="Pause marker"]

when you need a break.

_Example 40. Inline image macro with positioning role_

image::/images/sunset.jpg[Sunset,150,150,role=left]
150 x 150 What a beautiful sunset!

image::/images/sunset.jpg[sunset]

Link Refs of asciidoctor css : 
...
- https://blog.anoff.io/2019-02-17-hugo-render-asciidoc/ (Andreas'Blog) Fontawesome 4.7.0
...
### inline bookmarks
<<bookmark-a>> <<bookmark-b>> <<bookmark-c>> <<bookmark-d>>

[[bookmark-a]]A) Inline anchors make arbitrary content referenceable.

[#bookmark-b]#B) Inline anchors can be applied to a phrase like this one.#

anchor:bookmark-c[]C) Use a cross reference to link to this location.

[[bookmark-d,last paragraph]] D) The xreflabel attribute will be used as link text in the cross-reference link.