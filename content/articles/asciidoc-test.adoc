...
* single_quotes ' around a phrase place 'emphasis'
* astericks * around a phrase make the text *bold*
* double astericks _*_* around one or more **L**etters in a word make those letters bold
* double underscore _ _ around a __sub__string in a word emphasize that substring
...
### Abbreviation
:imho: pass:[<abbr title="in my humble opinion">IMHO</abbr>]

{imho} slide on to pop full text
