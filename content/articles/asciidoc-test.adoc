...
Ref of asciidoc syntax : https://mrduguo.github.io/asciidoctor.org/docs/asciidoc-syntax-quick-reference/

css : https://mrduguo.github.io/asciidoctor.org/stylesheets/styles.css

js : https://mrduguo.github.io/asciidoctor.org/javascripts/vendor/custom.modernizr.js
